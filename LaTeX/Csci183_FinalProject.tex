...
\title{\textbf{Applied Data Science}\\ % Title
Csci 183: Final Project} % Subtitle
\author{\textsc{R. Johnson, R. Young, G. Nguyen} % Author
...
\begin{abstract}
What are you intending to do in your project. To be precise a complete summary of your ideas, including methods, algorithms you are planning to implement, your comparison algorithms, evaluation strategies, experiment etc.A tentative plan and timeline.
asdf
\end{abstract}
